[xde-theme-warthogs -- release notes.  2021-12-07]: #

Maintenance Release 1.2
=======================

This is the third release of the `xde-theme-warthogs` package.  This
...
[GitHub](https://github.com/bbidulock/xde-theme-warthogs/issues).
